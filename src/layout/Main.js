...
class Main extends React.Component {
    ...
    componentDidMount() {  //срабатывает после загрузки страницы
        fetch('http://www.omdbapi.com/?apikey=f00c6d83&s=matrix') //для удобства и читабельности, содержимое подгруженное по ссылке выше нужно скопировать и перенести в json editor online;
